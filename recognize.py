...
classifier = cv2.CascadeClassifier(
    r'C:/Users/DELL/OneDrive/Desktop/face_det/face_det/haarcascade_frontalface_default.xml'
)

# Your trained face-recognition model (CNN)
model = load_model(
    r"C:/Users/DELL/OneDrive/Desktop/face_det/face_det/final_model.h5"
)

# URL of your IP Camera (IP Webcam app)
URL = 'http://192.168.137.249:8080/shot.jpg'
...
def get_pred_label(pred):
    ...
    labels = ["Amogh"]    # Add more names if you train multiple people
    return labels[pred]
